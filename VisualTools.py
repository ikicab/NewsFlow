...
def plot_newsFlow(N, F0, eta, lambda_F, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
    """Visualises the simulation data."""

    g = ig.Graph.Barabasi(N, avgDeg, power=power) # generate the BA graph
    g.simplify()
...
def rho_heatmaps(N, F0, lambdaF_list, eta_list, rep, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
...
def time_evolution_F0(N, list_F0, lambda_F, eta, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
...
def time_evolution_lambda_F_eta(N, F0, list_lambdaF, list_eta, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
...
def rho_lambdaF(list_N, list_rhoF0, rep, list_lambdaF, eta=1, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
...
def rho_eta(list_N, list_rhoF0, rep, list_eta, lambda_F=1, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
...
def get_media_repertoire(N, lambda_F, eta, sfreq, rhoF0=0.5, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
...
def get_media_subscriptions(N, lambda_F, eta, sfreq, rhoF0=0.5, avgDeg=20, power=-2.5, M=10, tol=0.0005, window_size=0, t_max=0):
